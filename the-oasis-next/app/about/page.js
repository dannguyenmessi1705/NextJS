...
// Set cache reload data cho page (Chỉ hoạt động ở môi trường production)
...
export default async function Page() {
  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* Đối với link image từ internet, database, xử lý bằng set size cho phần tử cha, rồi fill ảnh vào */}
      <div className="col-span-2 relative aspect-square">
        <Image
          src="/about-2.jpg"
          fill
          className="object-cover"
          blurDataURL="blur" // Tạo hiệu ứng mờ khi tải ảnh (đối với ảnh nhập từ link)
